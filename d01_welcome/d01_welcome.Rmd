...
This course is an introduction to data science, with an emphasis on statistical thinking and best practices.
...
A - While statistics $\ne$ data science, they are very closely related and have tremendous of overlap. Hence, this course is a great way to get started with statistics. However this course is **not** your typical statistics course.
...
- On Github, download the assignment called `AE 01a - UN Votes`.
...
- On Github, download the assignment called called `AE 01b - COVID`.
